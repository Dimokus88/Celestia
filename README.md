...
# Нода валидатора Celestia, развертка в Akash Network.
...
[English version](https://github.com/Dimokus88/Akash-Nodes-Lab/blob/main/Guide/Deploy_node_guide.md#english-version) | [Русская версия](https://github.com/Dimokus88/Akash-Nodes-Lab/blob/main/Guide/Deploy_node_guide.md#%D1%80%D1%83%D1%81%D1%81%D0%BA%D0%B0%D1%8F-%D0%B2%D0%B5%D1%80%D1%81%D0%B8%D1%8F) 
...
___
# Русская версия
### Развертка ноды Celestia:

Разверните файл [deploy.yml](https://raw.githubusercontent.com/Dimokus88/Akash-Nodes-Lab/main/Active_testnets/Celestia/celestia_deploy.yml) ноды с помощью **Cloudmos (Akashlytics)**  ([инструкция по использованию здесь](https://github.com/Dimokus88/Akash-Nodes-Lab/blob/main/Guide/Cloudmos(Akashlytics)_RU.md)) установив значения в соответствующих переменных  `deploy.yml`: 
